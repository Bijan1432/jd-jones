<?php include 'include/header.php'; ?>
        <div class="banner clearfix">
            <div class="banner-bg g-prod-compression-packing" style="background-image:URL(images/valve/ban_ind_valve.jpg)">
        ...
        <div class="container space-bttm-40 content-body">
            <div class="row">
                <div class="headline text-center clearfix">
                    <h2 class="cross-line"><span>Valve</span></h2>
                </div>
                <div class="clearfix">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <figure>
                            <div><img class="img-circle" src="images/valve/logo_ind_valve.jpg"></div>
                        </figure>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 pull-right">
                        <p class="lead semibold">Application</p>
                        <button class="accordion accbtn" rel="Trunion Mounted Ball Valves">
				<pan>Trunion Mounted Ball Valves</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/graphite-sealing-products/na-714">NA 714</a></li>
                                    <li><a href="/our-products/low-emission-packing/na-sp-1-low-emission-packing-ring-set">NA SP-1 Low Emission Packing Ring Set</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Floating Ball Valves">
				<pan>Floating Ball Valves</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/industrial-polymer-products/ptferptfe-valve-seat">PTFE/RPTFE VALVE SEAT</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Gate Globe Check Valves">
				<pan>Gate Globe Check Valves</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/compression-packing/na-701-707">NA 701 + 707</a></li>
                                    <li><a href="/our-products/low-emission-packing/na-b-3-707-low-emission-packing-set">NA B-3 + 707 Low Emission Packing Set</a></li>
                                    <li><a href="/our-products/low-emission-packing/na-sp-1-low-emission-packing-ring-set">NA SP-1 Low Emission Packing Ring Set</a></li>
                                    <li><a href="/our-products/compression-packing/na-781">NA 781</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Knife Gate Valves">
				<pan>Knife Gate Valves</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/compression-packing/na-730">NA 730</a></li>
                                    <li><a href="/our-products/compression-packing/copper-packing">COPPER PACKING</a></li>
                                    <li><a href="/our-products/compression-packing/na-763rc">NA 763RC</a></li>
                                    <li><a href="/our-products/compression-packing/na-758h">NA 758H</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Butterfly Valves">
				<pan>Butterfly Valves</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/industrial-polymer-products/rtfe-seats-wire-winding">RTFE Seats with Wire Winding</a></li>
                                    <li><a href="/our-products/compression-packing/ptfe-v-cup-end-rings-and-braided-intermediate-rings-set">PTFE V-CUP END RINGS AND BRAIDED INTERMEDIATE RINGS SET</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Presssure Seal Valves/Bolted Bonnet Valves">
				<pan>Presssure Seal Valves/Bolted Bonnet Valves</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                        ...
                        <button class="accordion accbtn" rel="Control Valves">
				<pan>Control Valves</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    ...
                                    <li><a href="/our-products/compression-packing/na-781">NA 781</a></li>
                                    <li><a href="/our-products/compression-packing/na-781g">NA 781G</a></li>
                                    <li><a href="/our-products/compression-packing/na-781a">NA 781A</a></li>
                                    <li><a href="/our-products/graphite-sealing-products/na-707t">NA 707T Graphite Tanged Ring</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Triple Offset Butterfly Valve">
				<pan>Triple Offset Butterfly Valve</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/graphite-sealing-products/ss-laminated-graphite-ring">Graphite Laminar Seal</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Piston Valve">
				<pan>Piston Valve</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="basic-padding">
                            <img src="images/valve/styles/large/public/logo_prod_compression_packing_0.jpg?itok=-rkx5ZEk" class="img-responsive" alt="banner">
                        </div>
                    </div>
                </div>
                <div class="row">
