...
(function($) {
    ...
    Drupal.overlay.loadChild = function(event) {
        ...
        event.data.sibling.removeClass('overlay-active').attr({
            'tabindex': -1
        });
        ...
        if (this.isOpen && !this.isClosing) {
            ...
            if (iframeWindow.Drupal && iframeWindow.Drupal.overlayChild) {
                ...
                this.activeFrame = $(iframe)
                    ...
                    .attr('title', Drupal.t('@title dialog', {
            ...
            // if the overlay is open and the clicked link is inside the overlay iframe.
                ...
                if (target.hostname != window.location.hostname) {
                    ...
                    if ($target[0].hash) {
                        ...
                        $target.attr('href', $.param.fragment(href, {
                    ...
                    if (params.destination && this.isAdminLink(params.destination)) {
                        var fragmentizedDestination = $.param.fragment(this.getPath(window.location), {
                            overlay: params.destination
                        });
                        $target.attr('href', $.param.querystring(href, {
    ...
    Drupal.overlay.eventhandlerOperateByURLFragment = function(event) {
        ...
        if (internalUrl) {
            ...
            var url = $.param.querystring(internalUrl, {
                render: 'overlay'
            });
