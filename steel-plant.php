<?php include 'include/header.php'; ?>
        ...
        <div class="banner clearfix">
            <div class="banner-bg g-prod-compression-packing" style="background-image:URL(images/steel-plant/ban_ind_steel.jpg)">
        ...
        <div class="container space-bttm-40 content-body">
            <div class="row">
                <div class="headline text-center clearfix">
                    <h2 class="cross-line"><span>Steel Plant</span></h2>
                </div>
                <div class="clearfix">
                    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                        <figure>
                            <div><img class="img-circle" src="images/steel-plant/logo_ind_steel.jpg"></div>
                        </figure>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 pull-right">
                        <p class="lead semibold">Application</p>
                        <button class="accordion accbtn" rel="Steam Valve">
				<pan>Steam Valve</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    ...
                                    <li><a href="/our-products/low-emission-packing/na-715">NA 715</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Valve Bonnets">
				<pan>Valve Bonnets</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                        ...
                        <button class="accordion accbtn" rel="Blast Furnace Gas Booster">
				<pan>Blast Furnace Gas Booster</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                        ...
                        <button class="accordion accbtn" rel="Blast Furnace Tuyere Stock Hot Blast Air">
				<pan>Blast Furnace Tuyere Stock Hot Blast Air</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/insulation/na-550-ceramic-rope">NA 550 Ceramic Rope</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Coke Oven Pitch Pumps">
				<pan>Coke Oven Pitch Pumps</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/compression-packing/na-754">NA 754</a></li>
                                    <li><a href="/our-products/compression-packing/na-751">NA 751</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Coke Oven Doors">
				<pan>Coke Oven Doors</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                        ...
                        <button class="accordion accbtn" rel="Ash Handling Pumps">
				<pan>Ash Handling Pumps</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/compression-packing/na-747">NA 747</a></li>
                                    <li><a href="/our-products/compression-packing/na-740">NA 740</a></li>
                                    <li><a href="/our-products/compression-packing/na-741">NA 741</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Blast Furnace Hot Blast Bleeder Valves">
				<pan>Blast Furnace Hot Blast Bleeder Valves</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                        ...
                        <button class="accordion accbtn" rel="Condensate Pumps">
				<pan>Condensate Pumps</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/compression-packing/na-758h">NA 758H</a></li>
                                    <li><a href="/our-products/compression-packing/na-802">NA 802</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Hot Water and Cold Water Pumps">
				<pan>Hot Water and Cold Water Pumps</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                        ...
                        <button class="accordion accbtn" rel="Cooling Tower Pumps">
				<pan>Cooling Tower Pumps</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/compression-packing/na-758h">NA 758H</a></li>
                                    <li><a href="/our-products/compression-packing/na-802sr">NA 802SR</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Insulation Cloth for BF and SMS Areas">
				<pan>Insulation Cloth for BF and SMS Areas</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/insulation/na-555-ceramic-clothtape">NA 555 Ceramic Cloth/Tape</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Phosphate Dozing Pumps">
				<pan>Phosphate Dozing Pumps</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                                    <li><a href="/our-products/compression-packing/na-745">NA 745</a></li>
                                    <li><a href="/our-products/compression-packing/na-763">NA 763</a></li>
                                    <li><a href="/our-products/compression-packing/na-802">NA 802</a></li>
                                </ul>
                            </div>
                        </div>
                        <button class="accordion accbtn" rel="Water Pumps (WMD)">
				<pan>Water Pumps (WMD)</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                        ...
                        <button class="accordion accbtn" rel="Sludge Pumps in Blast Furnace">
				<pan>Sludge Pumps in Blast Furnace</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                        ...
                        <button class="accordion accbtn" rel="Chemical Pumps in Coke Oven Plant">
				<pan>Chemical Pumps in Coke Oven Plant</pan>
			  </button>
                        <div class="panel">
                            <div>
                                <ul class="clearfix">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="basic-padding">
                            <img src="images/steel-plant/styles/large/public/logo_prod_compression_packing_0.jpg?itok=-rkx5ZEk" class="img-responsive" alt="banner">
                        </div>
                    </div>
                </div>
                <div class="row">
